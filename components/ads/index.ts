...
import { EN05KvartettenA, EN05KvartettenB, EN05KvartettenC, EN05KvartettenBar, EN05KvartettenLabels } from './energi/EN05-Kvartetten';
...
export const AD_COMPONENTS: Record<string, AdComponent> = {
  ...
  'EN05-KV-LBL': EN05KvartettenLabels,
};
